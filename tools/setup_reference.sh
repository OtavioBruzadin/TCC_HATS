...
echo "  make run-craam     roda o código do CRAAM"
echo "  make diff          roda os dois e compara"
echo "  make bench-craam   compara o desempenho"
echo "  make craam-shell   sessão Python com o HATS.py deles"
